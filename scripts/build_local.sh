...
RUNTIME_TAG="${RUNTIME_TAG:-4.6.0-py3.12.12-v1}"
...
build_tracked "$ROOT_DIR/Dockerfile" nd_apps-shiny_serve:local

echo "Done. Image tagged as nd_apps-shiny_serve:local"
